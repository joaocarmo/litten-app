...
export default class Litten implements LittenClass {
  ...
  constructor({
    ...
    this.#userUid = this.#user?.userUid || this.#user?.userAuthUid
  }
  ...
  toJSON() {
    ...
    object.location.coordinates = {
      _latitude: object.location.coordinates._latitude,
      _longitude: object.location.coordinates._longitude,
    }
    object.metadata = {
      createdAt: {
        _seconds: object.metadata.createdAt?._seconds,
      },
      updatedAt: {
        _seconds: object.metadata.updatedAt?._seconds,
      },
    }
