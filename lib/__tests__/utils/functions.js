...
describe('Test the "convertLength" function', () => {
  ...
  it(`returns the value in '${MEASURE_MI}' if not using metric units`, () => {
    expect(convertLength(1, false)).toEqual(1)
    expect(convertLength(35, false)).toEqual(56)
    expect(convertLength(100, false)).toEqual(160)
  })
})
...
describe('Test the "degToRad" function', () => {
  it.todo('Converts degrees to radians')
})

describe('Test the "distanceBetween" function', () => {
  it.todo('Calculates the minimum distance between two coordinates on Earth')
})

describe('Test the "getFromListByKey" function', () => {
  it.todo('Retrieves a single object from an array of objects')
})
