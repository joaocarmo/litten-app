...
describe('Test the "convertLength" function', () => {
  ...
  it(`returns the same value if the unit is ${MEASURE_KM} or not specified`, () => {
    ...
    expect(convertLength(value2, MEASURE_KM)).toEqual(value2)
  })

  it(`returns the value in mi if the unit is ${MEASURE_MI}`, () => {
    expect(convertLength(1, MEASURE_MI)).toEqual(1)
    expect(convertLength(35, MEASURE_MI)).toEqual(56)
    expect(convertLength(100, MEASURE_MI)).toEqual(160)
  })
})
