...
export function littenPhotoValidator(
  photos: string[],
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
...
export function littenTitleValidator(
  title: string,
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
...
export function littenSpeciesValidator(
  species: string,
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
...
export function littenTypeValidator(
  type: string,
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
...
export function littenStoryValidator(
  story: string,
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
...
export function littenLocationValidator(
  location: GLocationParsed,
): {| error: boolean, errorMessage: string |} {
  const conditions = [
    {
      testFn: notNothing(),
