...
/**
 * Async simple timeout
 * @async
 * @param {number} [ms=0] - Amount of time to wait before resolving in ms
 ...
 * @async
 * @param {function} fn - Function to execute after at the end of the timeout
 * @param {number} [ms=0] - Amount of time to wait before executing 'fn' in ms
 * @param {...any} args - Any number of extra arguments to be passed to 'fn'
 * @returns {Promise<any>}
 */
