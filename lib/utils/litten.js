...
export const littenSpeciesList: ListOfSpecies[] = [
  {
    ...
    label: translate('litten.species.dog', { count: 2 }),
  ...
  },
  {
    ...
    label: translate('litten.species.cat', { count: 2 }),
  ...
  },
  {
    ...
    label: translate('litten.species.bird', { count: 2 }),
  ...
  },
  {
    ...
    label: translate('litten.species.rabbit', { count: 2 }),
  ...
  },
  {
    ...
    label: translate('litten.species.rodent', { count: 2 }),
  ...
  },
  {
    ...
    label: translate('litten.species.other', { count: 2 }),
...
export const littenTypesKeys: { [key: string]: string } = {
  [LITTEN_TYPE_ADOPT]: 'adopt',
  [LITTEN_TYPE_BREED]: 'breed',
