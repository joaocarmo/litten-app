...
export const STRUCTURE_TEMPLATE_SCREEN_HEADER_PROFILE_WIDTH = vw(85)
...
export const UI_ABOUT_LOGO_WIDTH = vw(100 * UI_ABOUT_LOGO_RATIO)
...
export const UI_BUTTON_FIXED_WIDTH = vw(77)
...
export const UI_IMAGE_PLACEHOLDER_ITEM_MARGIN = vw(0.5)
...
export const UI_MAP_MIN_HEIGHT = vh(55)
...
export const DEBOUNCE_TIMEOUT = 700 // ms
