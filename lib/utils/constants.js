...
// UI
export const DEVICE_HEIGHT: any = vh(100)
export const DEVICE_WIDTH: any = vw(100)
...
export const STRUCTURE_TEMPLATE_SCREEN_HEADER_HEIGHT: any = vh((1 / 10) * 100)
export const STRUCTURE_TEMPLATE_SCREEN_HEADER_PADDING_BOTTOM = 24
export const STRUCTURE_TEMPLATE_SCREEN_HEADER_PROFILE_WIDTH: any = vw(85)
export const STRUCTURE_TEMPLATE_SCREEN_HEADER_WIDTH: any = vw(90)
...
export const UI_ABOUT_LOGO_HEIGHT: any = vh(5)
export const UI_ABOUT_LOGO_RATIO = 3.625
export const UI_ABOUT_LOGO_WIDTH: any = vw(100 * UI_ABOUT_LOGO_RATIO)
...
export const UI_BUTTON_FIXED_WIDTH: any = vw(77)
...
export const UI_EMPTY_PLACEHOLDER_IMAGE: any = vw(30)
...
export const UI_IMAGE_PLACEHOLDER_ITEM_MARGIN: any = vw(0.5)
export const UI_IMAGE_PLACEHOLDER_ITEM_SIZE: any = vw(21)
...
export const UI_MAP_MIN_HEIGHT: any = vh(55)
...
export const LITTEN_FILTER_LOCATION_RADIUS_DEFAULT = 0
