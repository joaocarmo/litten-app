...
import { useCurrentlyActiveChat } from 'hooks'
...
const ChatOptions: (args: any) => Node = ({
  chat = {},
  litten = {},
  recipient = {},
  user = {},
  ...
  const chatUid = useMemo(() => chat.id || currentlyActiveChat, [
    chat.id,
    currentlyActiveChat,
  ])
  ...
  const deleteConversation = useCallback(async () => {
    const thisChat = new Chat({ id: chatUid })
        ...
        onSelect: () =>
          navigation.navigate(SCREEN_TAB_NAV_PROFILE, {
            ...
            params: {
              ...
              initialContent: prepareReportMessage({ id: chatUid }, recipient),
            },
            initial: false,
          }),
        disabled: !chatExists,
