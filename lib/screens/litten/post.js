...
const LittenPostScreen: (args: any) => React$Node = ({
  ...
  const withPaddingBottomMultiplied = usePaddingBottom(
    STRUCTURE_PADDING_MULTIPLIER,
  )
    ...
    <View style={styles.littenPostContainer}>
      <ScrollView
        ...
        <Carousel
          ...
          fill
        />
        <View style={[styles.littenPostContent, withPaddingBottomMultiplied]}>
      ...
      <View style={[styles.littenPostFooter, withPaddingBottom]}>
