...
import { UIActionSheet, UIButton, UIText } from 'ui-elements'
import { vh } from 'react-native-expo-viewport-units'
import MapView, { Marker } from 'react-native-maps'
import { isValidLocation } from 'utils/functions'
import {
...
const NewLocationForm: () => React$Node = ({
  authenticatedUser: { location: profileLocation },
  setLocation,
  setCountry,
}) => {
  ...
  */
  ...
  const chooseLocation = () => {
    if (isValidLocation(selectLocation)) {
