...
const NewForm: (args: any) => React$Node = ({
  ...
  const littenSpecies = getFromList(littenSpeciesList, species)?.label
  const littenType = getFromList(littenTypes, type)?.label
  ...
  return (
    <>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.uiSpacer} />
        <UIButton onPress={submitForm} fluid secondary>
          {translate('screens.new.post')}
        </UIButton>
        <View style={styles.uiSpacer} />
        <UIButton onPress={clearForm} fluid danger>
