...
const EditScreen = () => (
  <StackTemplate header={translate('screens.profile.edit')}>
    <Edit />
  </StackTemplate>
)
...
const ReportScreen = ({ route }) => (
  <StackTemplate header={translate('screens.profile.contactUs')}>
...
const AboutScreen = () => (
  <StackTemplate header={translate('screens.profile.about')}>
    <About />
  </StackTemplate>
)
...
const stackScreens = [
  ...
  {
    key: SCREEN_DEV_STORYBOOK,
    name: SCREEN_DEV_STORYBOOK,
