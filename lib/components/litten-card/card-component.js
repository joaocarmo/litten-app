...
const LittenCardComponent: (props: LittenCardComponentProps) => React$Node = ({
  distance: distanceKM,
  editable = false,
  isFavourite = false,
  litten = {},
...
export default (memo<LittenCardComponentProps>(
  LittenCardComponent,
  areEqual,
): React$AbstractComponent<LittenCardComponentProps, mixed>)
