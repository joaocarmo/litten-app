...
import { iconOrganization, placeholderCat } from 'images'
import {
  Cog as CogIcon,
  HeartFill,
  HeartOutline,
...
const LittenCard: (args: any) => React$Node = ({
  ...
  const setUp = useCallback(async () => {
    const userInfo = new User({ id: litten.userUid })
    await userInfo.get()
    setUser(userInfo)
  ...
  return (
    <Pressable
      ...
      style={[elevatedStyle, styles.cardContainer]}>
