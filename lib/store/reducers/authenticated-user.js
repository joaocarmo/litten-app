  ...
  (draft: AuthenticatedUser, action: any) => {
    switch (action.type) {
      ...
      case AUTH_USER_SET_EMAIL:
        ...
        draft.extra.emailVerified = false
        break
      case AUTH_USER_SET_EMAIL_VERIFIED:
        if (draft.basic) {
          draft.basic.emailVerified = action.payload
        }
        draft.extra.emailVerified = action.payload
        break
