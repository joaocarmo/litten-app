...
const authenticatedUserSlice: any = createSlice<AuthenticatedUser>({
  ...
  reducers: {
    ...
    clearBasic(state, action: PayloadAction<void>) {
      state.basic = null
    },
    clearExtra(state, action: PayloadAction<void>) {
      state.extra = userSchema
    },
    clearSavedSearch(state, action: PayloadAction<void>) {
