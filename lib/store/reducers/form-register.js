...
const formRegisterSlice: any = createSlice<RegisterForm>({
  name: 'formRegister',
  initialState,
  reducers: {
    clearErrorsRegisterForm(state, action: PayloadAction<void>) {
      state.error = initialState.error
      state.errorMessage = initialState.errorMessage
    },
    clearRegisterForm(state, action: PayloadAction<void>) {
      state.avatar = null
      state.callingCode = ''
      state.country = ''
      state.email = ''
